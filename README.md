...
Hey there! Welcome to the codebase for my personal website - a digital playground where I showcase my projects, skills, and journey as a developer.
...
```bash
git clone https://github.com/YOUR_USERNAME/charuvarthan-t.github.io.git
cd charuvarthan-t.github.io
```
